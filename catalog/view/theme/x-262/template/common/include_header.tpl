...
<div id='autor_info' title='Design Studio WWW' style='text-align:justify;'>
	<p>
		<a href='http://www.web.pc.pl/blog/'><img src='http://www.dswww.pl/templates/dswww/images/logo.png'/ alt='http://www.web.pc.pl/blog/' title='http://www.web.pc.pl/blog/'></a><br/>
		Motyw graficzny dla systemów zarządzania treścią: <a href='http://www.dswww.pl/oferta/tworzenie-stron-internetowych.html' title='Tworzenie stron WWW'>dswww.pl - Tworzenie stron WWW</a> - Firma zajmująca się tworzeniem internetowych stron, szablonów dla stron oraz sklepów internetowych. 
	</p>
	<p>
		<a href='http://fireplaceretail.co.uk/index.php?route=product/category&path=17_63' title='Stoves'>Stoves - Fireplace</a> - Firma partnerska w tworzeniu stron internetowych.
	</p>
</div>
