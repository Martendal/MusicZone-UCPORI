				...
				<div class="pattern">
					<div class="container">
						<div class="row">
                            ...
                            <!-- Links -->
				               <ul class="menu">
				               	<li><i class="fa fa-university" aria-hidden="true"></i><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a></li>
				               	<li><i class="fa fa-heart-o" aria-hidden="true"></i><a href="<?php echo $wishlist; ?>" id="wishlist-total"><?php echo $text_wishlist; ?></a></li>
				               	<li><i class="fa fa-cart-plus" aria-hidden="true"></i><a href="<?php echo $shopping_cart; ?>"><?php echo $text_shopping_cart; ?></a></li>
				               	<li><i class="fa fa-check-circle" aria-hidden="true"></i><a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></li>
				               </ul>
